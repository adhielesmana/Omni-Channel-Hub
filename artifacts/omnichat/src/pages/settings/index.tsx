...
import { Bell, Globe, Link2, Repeat2, Shield, Sliders, Webhook, ChevronRight, Check, Copy, RefreshCw } from "lucide-react";
...
export default function Settings() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* Settings sidebar */}
      <aside className="w-56 flex-shrink-0 border-r bg-card/50 flex flex-col py-6 px-3 gap-0.5 overflow-y-auto">
